        ...
        {displayed.length > 0 && (
          <div className={styles.grid} role="list" aria-label="Watched shows">
            {displayed.map((show, index) => (
              ...
              >
                {/* WatchlistCard2 — reused with watched mode:
                    - onMarkWatched NOT passed → check btn hidden
                    - show.watchedDate present → shows date + green ribbon
                    - removeLabel changed for context */}
                <WatchlistCard2
                  show={show}
